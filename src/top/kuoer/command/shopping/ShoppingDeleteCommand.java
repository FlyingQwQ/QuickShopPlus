...
public class ShoppingDeleteCommand implements SimpleCommand {
    ...
    public ShoppingDeleteCommand(QuickShopPlus quickShopPlus, String permission, ShopType shopType, boolean isConsole) {
    ...
    public void run(CommandSender sender, String[] args) {
        ...
        if(null != shop) {
            ...
            sender.sendMessage("§a已经将这个商店的限购移除了");
        }
    }
